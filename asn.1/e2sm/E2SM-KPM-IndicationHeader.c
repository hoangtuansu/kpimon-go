...
static asn_TYPE_member_t asn_MBR_indicationHeader_formats_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct indicationHeader_formats, choice.indicationHeader_Format1),
...
static asn_CHOICE_specifics_t asn_SPC_indicationHeader_formats_specs_2 = {
	sizeof(struct indicationHeader_formats),
	offsetof(struct indicationHeader_formats, _asn_ctx),
	offsetof(struct indicationHeader_formats, present),
	sizeof(((struct indicationHeader_formats *)0)->present),
