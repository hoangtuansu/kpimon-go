...
static asn_TYPE_member_t asn_MBR_rrcType_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct rrcType, choice.lTE),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct rrcType, choice.nR),
...
static asn_CHOICE_specifics_t asn_SPC_rrcType_specs_2 = {
	sizeof(struct rrcType),
	offsetof(struct rrcType, _asn_ctx),
	offsetof(struct rrcType, present),
	sizeof(((struct rrcType *)0)->present),
