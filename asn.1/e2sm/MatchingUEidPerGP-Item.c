...
static asn_TYPE_member_t asn_MBR_matchedPerGP_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct matchedPerGP, choice.noUEmatched),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct matchedPerGP, choice.oneOrMoreUEmatched),
...
static asn_CHOICE_specifics_t asn_SPC_matchedPerGP_specs_2 = {
	sizeof(struct matchedPerGP),
	offsetof(struct matchedPerGP, _asn_ctx),
	offsetof(struct matchedPerGP, present),
	sizeof(((struct matchedPerGP *)0)->present),
