...
static asn_TYPE_member_t asn_MBR_nodeType_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct nodeType, choice.global_eNB_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct nodeType, choice.global_en_gNB_ID),
...
static asn_CHOICE_specifics_t asn_SPC_nodeType_specs_2 = {
	...
	offsetof(struct nodeType, _asn_ctx),
	offsetof(struct nodeType, present),
	sizeof(((struct nodeType *)0)->present),
