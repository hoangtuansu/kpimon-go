...
/* Dependencies */
typedef enum matchedPerGP_PR {
	matchedPerGP_PR_NOTHING,	/* No components present */
	matchedPerGP_PR_noUEmatched,
	matchedPerGP_PR_oneOrMoreUEmatched
	/* Extensions may appear below */
	
} matchedPerGP_PR;
typedef enum noUEmatched {
	noUEmatched_true	= 0
	/*
